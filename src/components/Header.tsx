      ...
      <div className="container mx-auto px-8">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center space-x-8">
            <Link to="/contact" className="flex items-center gap-2 text-xs tracking-widest hover:text-primary/80 transition-colors uppercase">
              <span className="w-1.5 h-1.5 rounded-full bg-current"></span>
              Enquire Now
            </Link>
            <Link to="/book" className="flex items-center gap-2 text-xs tracking-widest hover:text-primary/80 transition-colors uppercase">
              <span className="w-1.5 h-1.5 rounded-full bg-current"></span>
              Book Directly
            </Link>
          </div>
          ...
          <Link to="/" className="flex flex-col items-center justify-center absolute left-1/2 transform -translate-x-1/2 group">
            <span className="text-[10px] tracking-[0.3em] uppercase mb-1 opacity-80 group-hover:opacity-100 transition-opacity">feel good resort</span>
            <span className="text-4xl font-thin tracking-wide font-serif group-hover:text-primary/90 transition-colors">hermes</span>
          </Link>

          {/* Right Actions */}
          <div className="flex items-center justify-end space-x-8 ml-auto">
            <Link to="/rooms" className="hidden lg:flex items-center gap-2 text-xs tracking-widest hover:text-primary/80 transition-colors uppercase">
              <span className="w-1.5 h-1.5 rounded-full bg-current"></span>
              Rooms & Suites
            </Link>
            ...
            <button
              ...
              className="p-2 hover:text-primary/80 transition-colors"
            >
