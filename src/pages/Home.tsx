...
const featuredRooms: Room[] = [
  {
    ...
    description:
      "Elegant room with king bed, floor-to-ceiling windows, and views of lush greenery. Features premium amenities and sophisticated décor.",
  },
  {
    id: "premium",
    title: "Premium Room",
    ...
    description:
      "Spacious room with separate living area, executive desk, and enhanced amenities. Perfect for extended stays.",
  },
  {
    ...
    description:
      "Luxurious suite with private balcony, kitchenette, and separate bedroom. Ideal for families seeking extra space and comfort.",
  },
];
          ...
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
            ...
            >
              ...
              <p className='text-lg text-foreground/80 mb-6'>
                Nestled just 500 meters from the pristine Kadike Beach in Udupi,
                Karnataka, Hermes Resort & Spa offers an unparalleled luxury
                experience where elegance meets the serenity of coastal living.
              </p>
              <p className='text-lg text-foreground/80 mb-8'>
                Whether you're planning a romantic getaway, a memorable wedding,
                a corporate retreat, or a family vacation, our world-class
                facilities and warm hospitality ensure your stay is nothing
        ...
        <div className='container mx-auto px-4'>
          ...
          >
            ...
            <p className='text-lg text-muted-foreground max-w-2xl mx-auto'>
              Experience unparalleled comfort in our thoughtfully designed
              accommodations
            </p>
          </motion.div>
        ...
        <div className='container mx-auto px-4'>
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
            ...
            >
              ...
              <p className='text-lg text-foreground/80 mb-6'>
                From intimate beach ceremonies to grand banquet celebrations,
                Hermes Resort offers versatile venues for your special
                occasions.
              </p>
              <ul className='space-y-4 mb-8'>
                <li className='flex items-start space-x-3'>
                  ...
                  <div>
                    ...
                    <p className='text-sm text-muted-foreground'>
                      Say 'I do' with your toes in the sand at Kadike Beach
                    </p>
                  </div>
                </li>
                <li className='flex items-start space-x-3'>
                  ...
                  <div>
                    ...
                    <p className='text-sm text-muted-foreground'>
                      Regal Hall accommodates up to 400 guests
                    </p>
                  </div>
                </li>
                <li className='flex items-start space-x-3'>
                  ...
                  <div>
                    ...
                    <p className='text-sm text-muted-foreground'>
                      Unique backwater wedding experience
                    </p>
                  </div>
                </li>
              </ul>
        ...
        <div className='container mx-auto px-4 text-center'>
          ...
          >
            ...
            <p className='text-xl text-white/80 mb-8 max-w-2xl mx-auto'>
              Book your luxury beachside getaway today and experience the finest
              hospitality in Udupi
            </p>
            <Link to='/book'>
              <Button
                size='lg'
                className='bg-gradient-gold hover:opacity-90 transition-opacity text-lg px-10 py-6'
              >
                Book Now
              </Button>
            </Link>
